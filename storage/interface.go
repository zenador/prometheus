...
func (q *MockQuerier) LabelValues(name string, matchers ...*labels.Matcher) ([]string, notes.Warnings, error) {
	return nil, nil, nil
}

func (q *MockQuerier) LabelNames(matchers ...*labels.Matcher) ([]string, notes.Warnings, error) {
	return nil, nil, nil
}
